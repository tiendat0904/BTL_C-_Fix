...
namespace QLBH.Model_Class
{
    public class Class_NguyenLieu
    {
        ...
        public Class_NguyenLieu(string MaNguyenLieu, string TenNguyenLieu, string DonViTinh, decimal SoLuong, decimal DonGiaNhap, decimal DonGiaBan, string CongDung, string YeuCau, string ChongChiDinh)
        {
        ...
        public decimal DonGiaNhap1 { get => DonGiaNhap; set => DonGiaNhap = value; }
        public decimal DonGiaBan1 { get => DonGiaBan; set => DonGiaBan = value; }
